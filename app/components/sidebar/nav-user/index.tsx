            ...
            <SidebarMenuItem>
                <DropdownMenu>
                    ...
                    >
                        ...
                        <DropdownMenuItem>
                            <a href="#" className="group w-full flex bg-red-50 cursor-pointer items-center gap-3 rounded-md px-3 py-2.5 transition-all duration-200 hover:bg-gray-100/80 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-200 focus:bg-gray-100/80 focus:text-gray-900">
